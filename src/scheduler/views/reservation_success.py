...
def reservation_success(request):
    ...
    if not next_event:
        return HttpResponse('Algo de errado aconteceu. Se você tiver acabado de marcar uma sessão e recebeu esta mensagem, por favor, mande um email para reikidaconceicao@gmail.com');
